...
var Swagger = /** @class */ (function (_super) {
    ...
    Swagger.prototype.create = function (option) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        formatedData = new _swagger_formatter__WEBPACK_IMPORTED_MODULE_2__["SwaggerFormatter"]().format(option, this.routes);
                        return [4 /*yield*/, fs_extra__WEBPACK_IMPORTED_MODULE_1__["pathExists"](option.outputPath)];
                    case 1:
                        isPathExist = _a.sent();
                        if (!(isPathExist === false)) return [3 /*break*/, 3];
                        return [4 /*yield*/, fs_extra__WEBPACK_IMPORTED_MODULE_1__["mkdir"](option.outputPath)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
                        ...
                        return [4 /*yield*/, fs_extra__WEBPACK_IMPORTED_MODULE_1__["writeFile"](swaggerConfigPath, JSON.stringify(formatedData))];
                    case 4:
                        //  await writeFile(swaggerConfigPath, JSON.stringify(formmatedData), { flag: 'w' });
                        _a.sent();
                        //copy swagger files
    ...
    Swagger.prototype.copySwaggerAssets_ = function (contentPath) {
        ...
        return Promise.all(assets.map(function (asset) {
            return fs_extra__WEBPACK_IMPORTED_MODULE_1__["copy"](path__WEBPACK_IMPORTED_MODULE_3__["join"](__dirname, "swagger_ui/" + asset), contentPath + asset);
        }));
    };
