...
/* harmony export */   SwaggerModel: () => (/* reexport safe */ _swagger_model__WEBPACK_IMPORTED_MODULE_0__.SwaggerModel)
/* harmony export */ });
...
const Body = (value, description) => {
    return (target, methodName, descriptor) => {
        ...
        (0,_helpers_extract_model__WEBPACK_IMPORTED_MODULE_1__.extractAndSaveModel)(value);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   IgnoreProperty: () => (/* binding */ IgnoreProperty)
/* harmony export */ });
/* harmony import */ var _handlers_swagger_handler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../handlers/swagger_handler */ "./src/handlers/swagger_handler.ts");
...
/* harmony export */   Description: () => (/* reexport safe */ _description__WEBPACK_IMPORTED_MODULE_6__.Description),
/* harmony export */   IgnoreProperty: () => (/* reexport safe */ _ignore_property__WEBPACK_IMPORTED_MODULE_1__.IgnoreProperty),
/* harmony export */   OptionalProperty: () => (/* reexport safe */ _optional_property__WEBPACK_IMPORTED_MODULE_7__.OptionalProperty),
/* harmony export */   Param: () => (/* reexport safe */ _param__WEBPACK_IMPORTED_MODULE_4__.Param),
/* harmony export */   Query: () => (/* reexport safe */ _query__WEBPACK_IMPORTED_MODULE_2__.Query),
/* harmony export */   Response: () => (/* reexport safe */ _response__WEBPACK_IMPORTED_MODULE_3__.Response),
/* harmony export */   Security: () => (/* reexport safe */ _security__WEBPACK_IMPORTED_MODULE_8__.Security),
/* harmony export */   Summary: () => (/* reexport safe */ _summary__WEBPACK_IMPORTED_MODULE_5__.Summary),
/* harmony export */   Tag: () => (/* reexport safe */ _tag__WEBPACK_IMPORTED_MODULE_9__.Tag)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   OptionalProperty: () => (/* binding */ OptionalProperty)
/* harmony export */ });
/* harmony import */ var _handlers_swagger_handler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../handlers/swagger_handler */ "./src/handlers/swagger_handler.ts");
...
const Response = (statusCode, value, contentType) => {
    return (target, methodName, descriptor) => {
        const className = target.constructor.name;
        const modelName = (0,_helpers_extract_model__WEBPACK_IMPORTED_MODULE_2__.extractAndSaveModel)(value);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DATA_TYPE: () => (/* reexport safe */ _data_type__WEBPACK_IMPORTED_MODULE_0__.DATA_TYPE)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SWAGGER_OUTPUT_PARAM: () => (/* binding */ SWAGGER_OUTPUT_PARAM)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SwaggerHandler: () => (/* binding */ SwaggerHandler)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   extractAndSaveModel: () => (/* binding */ extractAndSaveModel)
/* harmony export */ });
...
const extractAndSaveModel = (value) => {
    let className = "";
    let type = (0,_get_data_type__WEBPACK_IMPORTED_MODULE_0__.getDataType)(value);
    ...
    if (type === _enums__WEBPACK_IMPORTED_MODULE_1__.DATA_TYPE.Function) { // means its class
        ...
        if ((0,_get_data_type__WEBPACK_IMPORTED_MODULE_0__.getDataType)(firstValue) === _enums__WEBPACK_IMPORTED_MODULE_1__.DATA_TYPE.Function) { // it is class
            type = (0,_get_data_type__WEBPACK_IMPORTED_MODULE_0__.getDataType)(firstValue);
            saveModelInfo(firstValue);
        }
    }
    else {
        if ((0,_is_custom_class__WEBPACK_IMPORTED_MODULE_3__.isCustomClass)(value)) {
            saveModelInfo(value);
        }
    }
    return className;
...
const getClassName = (value) => {
    const type = (0,_get_data_type__WEBPACK_IMPORTED_MODULE_0__.getDataType)(value);
    if (type === _enums__WEBPACK_IMPORTED_MODULE_1__.DATA_TYPE.Function) { // means its class
        return (new value()).constructor.name;
    }
    else {
        if ((0,_is_custom_class__WEBPACK_IMPORTED_MODULE_2__.isCustomClass)(value)) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getParamSchema: () => (/* binding */ getParamSchema)
/* harmony export */ });
...
const getParamSchema = (value) => {
    const modelName = (0,_extract_model__WEBPACK_IMPORTED_MODULE_0__.extractAndSaveModel)(value);
    const dataType = (0,_get_data_type__WEBPACK_IMPORTED_MODULE_1__.getDataType)(value);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   isCustomClass: () => (/* binding */ isCustomClass)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SwaggerFormatter: () => (/* binding */ SwaggerFormatter)
/* harmony export */ });
/* harmony import */ var _handlers_swagger_handler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../handlers/swagger_handler */ "./src/handlers/swagger_handler.ts");
...
class SwaggerFormatter {
    ...
    getModels_() {
        ...
        const createSwaggerModelSchemas = (model) => {
            if ((0,_is_custom_class__WEBPACK_IMPORTED_MODULE_8__.isCustomClass)(model.classInstance)) {
                ...
                keys.forEach(key => {
                    ...
                    const dataType = (0,_helpers_get_data_type__WEBPACK_IMPORTED_MODULE_3__.getDataType)(propValue);
                    const paramInfo = {
                        type: dataType
                    };
                    if (dataType === _enums__WEBPACK_IMPORTED_MODULE_6__.DATA_TYPE.Array && propValue.length > 0) {
                        const firstItem = propValue[0];
                        const clasName = (0,_get_class_name__WEBPACK_IMPORTED_MODULE_7__.getClassName)(firstItem);
                        ...
                        paramInfo.items = (0,_helpers_get_param_schema__WEBPACK_IMPORTED_MODULE_2__.getParamSchema)(firstItem);
                    }
            ...
            workerInfo.responses.forEach(response => {
                ...
                response.contentType.forEach(contentType => {
                    result[response.statusCode].content[contentType] = {
                        schema: (0,_helpers_get_param_schema__WEBPACK_IMPORTED_MODULE_2__.getParamSchema)(response.value)
                    };
                });
            });
        }
        ...
        if (workerInfo != null) {
            ...
            workerInfo.params.forEach(param => {
                params.push({
                    ...
                    required: true,
                    schema: (0,_helpers_get_param_schema__WEBPACK_IMPORTED_MODULE_2__.getParamSchema)(param.value),
            ...
            workerInfo.queries.forEach(query => {
                params.push({
                    ...
                    required: true,
                    schema: (0,_helpers_get_param_schema__WEBPACK_IMPORTED_MODULE_2__.getParamSchema)(query.value),
            ...
            if (body != null) {
                params.push({
                    ...
                    required: true,
                    schema: (0,_helpers_get_param_schema__WEBPACK_IMPORTED_MODULE_2__.getParamSchema)(body.value),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Body: () => (/* reexport safe */ _decorators_index__WEBPACK_IMPORTED_MODULE_1__.Body),
/* harmony export */   DATA_TYPE: () => (/* reexport safe */ _enums_index__WEBPACK_IMPORTED_MODULE_2__.DATA_TYPE),
/* harmony export */   Description: () => (/* reexport safe */ _decorators_index__WEBPACK_IMPORTED_MODULE_1__.Description),
/* harmony export */   IgnoreProperty: () => (/* reexport safe */ _decorators_index__WEBPACK_IMPORTED_MODULE_1__.IgnoreProperty),
/* harmony export */   OptionalProperty: () => (/* reexport safe */ _decorators_index__WEBPACK_IMPORTED_MODULE_1__.OptionalProperty),
/* harmony export */   Param: () => (/* reexport safe */ _decorators_index__WEBPACK_IMPORTED_MODULE_1__.Param),
/* harmony export */   Query: () => (/* reexport safe */ _decorators_index__WEBPACK_IMPORTED_MODULE_1__.Query),
/* harmony export */   Response: () => (/* reexport safe */ _decorators_index__WEBPACK_IMPORTED_MODULE_1__.Response),
/* harmony export */   Security: () => (/* reexport safe */ _decorators_index__WEBPACK_IMPORTED_MODULE_1__.Security),
/* harmony export */   Summary: () => (/* reexport safe */ _decorators_index__WEBPACK_IMPORTED_MODULE_1__.Summary),
/* harmony export */   Swagger: () => (/* reexport safe */ _models_index__WEBPACK_IMPORTED_MODULE_0__.Swagger),
/* harmony export */   SwaggerModel: () => (/* reexport safe */ _abstracts_index__WEBPACK_IMPORTED_MODULE_3__.SwaggerModel),
/* harmony export */   Tag: () => (/* reexport safe */ _decorators_index__WEBPACK_IMPORTED_MODULE_1__.Tag)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Swagger: () => (/* reexport safe */ _swagger__WEBPACK_IMPORTED_MODULE_0__.Swagger)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SwaggerLogger: () => (/* reexport safe */ _logger__WEBPACK_IMPORTED_MODULE_0__.SwaggerLogger)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SwaggerLogger: () => (/* binding */ SwaggerLogger)
/* harmony export */ });
class SwaggerLogger {
    static warning(msg) {
...
/******/ 	module.exports["fortjs-swagger"] = __webpack_exports__;
/******/ 	
/******/ })()
;
